...
public class SellerController {
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller ) throws Exception, MessagingException {
        ...
        String text =" welcome to ecommerce plateforme , verify your account using this link";
...
public ResponseEntity<List<Seller>> getAllSeller(
    ...
    public ResponseEntity<ApiResponse> sentOtpHandler(@RequestBody VerificationCode req)throws Exception {
       ...
       //VerificationCode verificationCode = verificationCodeRepository.createVerification();
       String subject = "Raoul nana Login otp";
